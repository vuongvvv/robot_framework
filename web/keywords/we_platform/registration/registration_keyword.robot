*** Settings ***
Resource    ../../../resources/locators/we_platform/registration/registration_locators.robot
...
Register Account
    [Arguments]    ${mobile_login}    ${user_login}    ${email}    ${password}
...
Verify Register Account Successful
    Verify Element Is Visible    ${lbl_registration_successful}
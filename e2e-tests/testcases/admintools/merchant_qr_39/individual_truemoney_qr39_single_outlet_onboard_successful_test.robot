...
TC_O2O_25427
    ...
    brand_call_verification_keywords.Verify Brand Information    service_type=TrueMoney    business_type=INDIVIDUAL    
    ...
    ...    mobile=${TEST_DATA_BRAND_CALL_VERIFICATION_BRAND_LAND_LINE}    email=${TEST_DATA_BRAND_CALL_VERIFICATION_BRAND_CONTACT_EMAIL}    date_of_birth=${TEST_DATA_BRAND_CALL_VERIFICATION_BIRTHDAY_ADMINTOOLS}
    ...
    # ASCO2O-24049: When Fraud Admin approved [TMN Only] merchant registration, then brand, shops onboarded to TrueYou
    ...
    # TMN already approved on their side
    ...
    Get Merchant Details    ${TEST_DATA_CMS_PROJECT_ID}    id=${TEST_DATA_QR39_MERCHANT_ID}&edit=true
    Response Correct Code    ${SUCCESS_CODE}
    Response Should Contain Property With Value    data..tmn.merchant_id    ${TRUEMONEY_BRAND_ID}
    Response Should Contain Property With Value    data.."trueyou".merchant_id    ${SHOP_TRUEYOU_TRUEYOU_SHOP_ID}

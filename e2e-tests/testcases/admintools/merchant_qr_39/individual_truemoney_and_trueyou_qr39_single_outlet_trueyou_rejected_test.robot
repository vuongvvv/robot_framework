...
Test Setup    Run Keywords    Open Browser With Option
...
${jpg_owner_certificate}    jpg_owner_certificate.jpg
${png_vat_registration}    png_vat_registration.png
${pdf_bank_passbook}    pdf_bank_passbook.pdf
${gif_household_registration}    gif_household_registration.gif
${jpg_company_registration}    jpg_company_registration.jpg
${jpg_rental_contract}    jpg_rental_contract.jpg
${jpg_other}    jpg_other.jpg

${gif_brand_image_logo}    gif_brand_image_logo.gif
${jpg_brand_image_store_front}    jpg_brand_image_store_front.jpg
${png_brand_image_menu}    png_brand_image_menu.png
${jpg_brand_image_map}    jpg_brand_image_map.jpg
${jpeg_brand_image_other}    jpeg_brand_image_other.jpeg

${gif_shop_image_logo}    gif_shop_image_logo.gif
${jpg_shop_image_store_front}    jpg_shop_image_store_front.jpg
${png_shop_image_menu}    png_shop_image_menu.png
${jpg_shop_image_map}    jpg_shop_image_map.jpg
${jpeg_shop_image_other}    jpeg_shop_image_other.jpeg

*** Test Cases ***
tmn_approved_ty_rejected
    ...
    [Tags]    E2EExclude    o2o-merchant    cms    trueyou    truemoney
    Get Search Category
    ...
    Post Upload File    ${TEST_DATA_BRAND_MONGO_ID}    BRAND_IMAGE_LOGO    ${jpeg_brand_image_other}
    Response Correct Code    ${CREATED_CODE}
    Post Upload File    ${TEST_DATA_BRAND_MONGO_ID}    BRAND_IMAGE_STORE_FRONT    ${jpeg_brand_image_other}
    Response Correct Code    ${CREATED_CODE}
    Post Upload File    ${TEST_DATA_BRAND_MONGO_ID}    BRAND_IMAGE_MENU    ${jpeg_brand_image_other}
    Response Correct Code    ${CREATED_CODE}
    Post Upload File    ${TEST_DATA_BRAND_MONGO_ID}    BRAND_IMAGE_MAP    ${jpeg_brand_image_other}
    Response Correct Code    ${CREATED_CODE}
    ...
    Post Upload File    ${SHOP_MONGO_ID}    SHOP_IMAGE_LOGO    ${jpeg_shop_image_other}
    Response Correct Code    ${CREATED_CODE}
    Post Upload File    ${SHOP_MONGO_ID}    SHOP_IMAGE_STORE_FRONT    ${jpeg_shop_image_other}
    Response Correct Code    ${CREATED_CODE}
    Post Upload File    ${SHOP_MONGO_ID}    SHOP_IMAGE_MENU    ${jpeg_shop_image_other}
    Response Correct Code    ${CREATED_CODE}
    Post Upload File    ${SHOP_MONGO_ID}    SHOP_IMAGE_MAP    ${jpeg_shop_image_other}
    Response Correct Code    ${CREATED_CODE}
    ...
    Wait Data To Sync On Cms    ${TEST_DATA_CMS_PROJECT_ID}    shop-trueyou    ${SHOP_TRUEYOU_CONTENT_ID}    data.status    FRAUD_REVIEW
    Get Content    ${TEST_DATA_CMS_PROJECT_ID}    brand-callverification    ${BRAND_CALL_VERIFICATION_CONTENT_ID}

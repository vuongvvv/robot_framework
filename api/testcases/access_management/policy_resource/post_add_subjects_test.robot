*** Settings ***
Documentation    Tests to verify that add subjects to policy api works correctly
...
TC_O2O_18212
    ...
    Post Create Policy    ${project_id}    { "subjects":[ "automated-1-${KEY}" ], "resources":[ "automated-1-${KEY}", "automated-2-${KEY}" ], "actions":[ "read", "write" ], "description":"This is automated policy" }
    Collect Policy Id From Response
    Post Add Subjects    ${project_id}    ${POLICY_ID}    {"subjects":["automated-2-${KEY}"]}

*** Settings ***
Documentation    [EDC] API to void point earn transaction
...
*** Test Cases ***
TC_O2O_26430
    [Documentation]    Call 'void earn transaction version 1'
    ...
    Response Should Contain Property With Value    transaction_type     POINT_CANCEL
...
TC_O2O_26420
    [Documentation]    Call 'void earn transaction version 2'
    [Tags]    Regression    High    Smoke
    Post Issue Point    { "brand_id":"${brand_id}", "outlet_id":"${outlet_id}", "terminal_id":"${terminal_id}", "acc_type":"${acc_type}", "acc_value":"${acc_value}", "amount": 5000 }
    Response Correct Code    ${SUCCESS_CODE}

*** Settings ***
Documentation    Tests to verify that the reprocess can work on "error.payment-transaction-{env}.customerPointConsumer-{env}" as expected.
...
*** Variables ***
${failed_payment_transaction_customer_api}    /point/api/process/failed-payment-transaction-customer
...
TC_O2O_03222
    ...
    Reprocess Messages On Error Topic Of Kafka    ${failed_payment_transaction_customer_api}
